...
export const metadata: Metadata = {
  title: "S.B. Auto Sales & Service Sirsaganj | पता और संपर्क",
  description: "S.B. Auto Sales & Service, Etawah Road, Sirsaganj का पता, फोन, map, sales, service, parts और finance सहायता की जानकारी।",
};
